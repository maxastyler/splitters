defmodule SplittersWeb.ExpenseLive.Index do
  ...
  def mount(_params, _session, socket) do
    {:ok, stream(socket, :expenses, Expenses.list_expenses_for_user(socket.assigns.current_user))}
  end
  ...
  @impl true
  def handle_info({SplittersWeb.ExpenseLive.FormComponent, {:saved, expense}}, socket) do
