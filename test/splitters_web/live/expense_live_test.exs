defmodule SplittersWeb.ExpenseLiveTest do
  use SplittersWeb.ConnCase

  import Phoenix.LiveViewTest
  import Splitters.ExpensesFixtures

  @create_attrs %{amount: 42, date: "2024-05-13T08:09:00Z", description: "some description"}
  @update_attrs %{amount: 43, date: "2024-05-14T08:09:00Z", description: "some updated description"}
